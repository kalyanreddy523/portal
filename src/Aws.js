                    ...
                    <div className="col-3">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title" style={{ fontFamily: "Verdana", fontSize: "18px" }}>AWS(Amazon Web Services)</h5>
                                <p className="card-text text-secondary" style={{ fontFamily: "Verdana", fontSize: "10px" }}>AWS(Amazon Web Services)-classroom</p>
                            </div>
